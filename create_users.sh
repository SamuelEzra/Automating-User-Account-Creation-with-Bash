...
# Check if the user file is available
if [[ -z "$1" ]]; then
    echo "Useage: $0 users.txt file"
    exit 1
fi
...
while IFS=';' read -r username groups; do
    ...
    # Generates and sets password for the user
...
echo "User has been successfully created." | tee -a $log_file
